...
// Mocka
#define COCOAPODS_POD_AVAILABLE_Mocka
#define COCOAPODS_VERSION_MAJOR_Mocka 0
#define COCOAPODS_VERSION_MINOR_Mocka 6
#define COCOAPODS_VERSION_PATCH_Mocka 1
